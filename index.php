         ...
         <picture>
            <source srcset="images/banner-5.webp" type="image/webp">
                  <img src="images/banner-5.jpg"
                   alt="International Air Freight Services - Eastern Cargo Carriers"
                   class="hero-bg"
                   loading="lazy">
        </picture>
         ...
         <picture>
            <source srcset="images/banner-1.webp" type="image/webp">
                  <img src="images/banner-1.jpg"
                   alt="Multimodal Transport Network - Eastern Cargo Carriers"
                   class="hero-bg"
                   loading="lazy">
        </picture>
          <div class="hero-content">
         ...
         <picture>
            <source srcset="images/banner-2.webp" type="image/webp">
                  <img src="images/banner-2.jpg"
                   alt="Ocean Freight Solutions - Eastern Cargo Carriers"
                   class="hero-bg"
                   loading="lazy">
        </picture>
          <div class="hero-content">
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <li><a href="#about" title="About Us" data-translate="About Us">About Us</a></li>
                        <li><a href="#career-contact" title="Build your career with Eastern Cargo Carriers – explore exciting opportunities today." data-translate="Careers">Careers</a></li>
                        <li><a href="#career-contact" title="Request your free logistics quote today and experience hassle-free shipping." data-translate="Get a Quote">Get a Quote</a></li>
                        <li><a href="teams.html" title="Meet our experienced team across India" data-translate="Our Team">Our Team</a></li>
                        <li><a href="#services" title="Wide variety of logistics services" data-translate="Our Services">Our Services</a></li>
                        <li><a href="#testimonial-section" title="Trusted experiences shared by our customers." data-translate="Client Reviews">Client Reviews</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h3 data-translate="Specialized Services">Specialized Services</h3>
                    <ul>
                        <li><a href="express-logistics-services.html" title="Express Logistics" data-translate="Express Logistics">Express Logistics</a></li>
                        <li><a href="healthcare-logistics.html" title="Healthcare Logistics" data-translate="Healthcare Logistics">Healthcare Logistics</a></li>
                        <li><a href="dgr-shipments.html" title="DG Shipments" data-translate="DG Shipments">DG Shipments</a></li>
                        <li><a href="project-logistics.html" title="Project Logistics" data-translate="Project Logistics">Project Logistics</a></li>
                    </ul>
                </div>
